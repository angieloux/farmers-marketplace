...
if Listing.count == 0 # if Listing table is empty
    ...
    5.times do
        ...
        # Create vegetables 
    5.times do
        Listing.create! name: Faker::Food.vegetables, price: Faker::Number.between(from: 1000, to: 10000), category_id: 1, user_id: Faker::Number.between(from: 1, to: 10), description: Faker::Lorem.paragraph(sentence_count: 2)
    end
        puts "Created vegetables" 

    # Create confectionery
    5.times do
        Listing.create! name: Faker::Dessert.variety, price: Faker::Number.between(from: 1000, to: 10000), category_id: 3, user_id: Faker::Number.between(from: 1, to: 10), description: Faker::Lorem.paragraph(sentence_count: 2)
    end
        puts "Created confectionery" 

    # Create meat 
    meats.each do |meat|
        Listing.create! name: meat, price: Faker::Number.between(from: 1000, to: 10000), category_id: 6, user_id: Faker::Number.between(from: 1, to: 10), description: Faker::Lorem.paragraph(sentence_count: 2)
